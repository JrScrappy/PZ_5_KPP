...
public class CollectionDAOImpl implements IDAO{
    ...
    static{
        ...
        colors.add(new Color(colorInc++,"Blue"));
        colors.add(new Color(colorInc++,"White"));
        ...
        transports.add(new Transport(transportInc++,54,360.0,"Plane","White",40000));
        transports.add(new Transport(transportInc++,3,180.0,"Truck","Blue",15000));
    }
